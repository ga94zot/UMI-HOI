# Attribution: visualisation fork of umi_transformers.py (formerly transformers_.py), derived
# from PViC `transformers.py` (https://github.com/fredzzhang/pvic, Frederic Zhang,
# BSD-3-Clause, see LICENSE). Renamed transformers_vis.py -> umi_transformers_vis.py on
# 2026-09-09; class names are kept as in PViC. UMI-HOI changes: same as umi_transformers.py
# plus attention-map export.
"""
...
Visualisation fork of umi_transformers.py -- keep in sync with it.
"""
import copy
import math
import torch
