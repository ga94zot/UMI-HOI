...
Visualisation fork of umi.py -- keep in sync with it.
...
# Attribution: fork of umi.py (formerly pvic.py), itself derived from PViC `pvic.py`
# (https://github.com/fredzzhang/pvic, Frederic Zhang, BSD-3-Clause, see LICENSE). Renamed
# pvic_vis.py -> umi_vis.py and class PViC -> UMI on 2026-09-09; all other names are kept as
# in PViC. UMI-HOI changes: same as umi.py plus attention-map export hooks used by
# visualization.py.
...
from umi_transformers_vis import (
    TransformerEncoder,
    TransformerDecoder,
...
def build_detector(args, obj_to_verb) -> UMI:
