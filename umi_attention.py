...
# ------------------------------------------------------------------------
# Attribution: taken from PViC `attention.py` (https://github.com/fredzzhang/pvic, Frederic
# Zhang, BSD-3-Clause, see LICENSE), which adapted it from Conditional DETR / PyTorch as
# noted. In UMI-HOI this file was `attention.py` until 2026-09-09 and is now
# `umi_attention.py`; class/function names are kept as in PViC.
# UMI-HOI change: multi_head_attention_forward implements the Semantic Multi-Head
# Attention (block-diagonal subject/object head projections, sub_headnum / obj_headnum).
# ------------------------------------------------------------------------
